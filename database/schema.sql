...
CREATE TABLE IF NOT EXISTS `Customers` (
  ...
  UNIQUE KEY `uk_Customers_CodeAccess` (`CodeAccess`),
...
-- ------------------------------------------------------------
-- Table: CustomerWebLoginAttempts
-- ------------------------------------------------------------
...
CREATE TABLE `UsersDesktop` (
    ...
    INDEX `idx_UsersDesktop_CreatedOn` (`CreatedOn`),
...
CREATE TABLE IF NOT EXISTS `PermissionRequests` (
  ...
  CONSTRAINT `fk_PermissionRequests_Customer` FOREIGN KEY (`CustomerId`) REFERENCES `Customers` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `fk_PermissionRequests_RequestedBy` FOREIGN KEY (`RequestedByAdminId`) REFERENCES `AdministratorsDesktop` (`Id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_PermissionRequests_ResolvedBy` FOREIGN KEY (`ResolvedByAdminId`) REFERENCES `AdministratorsDesktop` (`Id`) ON DELETE RESTRICT,
  CONSTRAINT `chk_PermissionRequests_Status` CHECK (`Status` IN ('Pending', 'Approved', 'Denied', 'Cancelled'))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- ----------------------------
-- Table: Notifications
-- ----------------------------
CREATE TABLE IF NOT EXISTS `Notifications` (
  ...
  CONSTRAINT `fk_Notifications_Customer` FOREIGN KEY (`CustomerId`) REFERENCES `Customers` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `fk_Notifications_Recipient` FOREIGN KEY (`RecipientAdminId`) REFERENCES `AdministratorsDesktop` (`Id`) ON DELETE CASCADE,
  CONSTRAINT `fk_Notifications_PermissionRequest` FOREIGN KEY (`PermissionRequestId`) REFERENCES `PermissionRequests` (`Id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- ----------------------------
...
-- ------------------------------------------------------------
-- Tables: secure remote ISAPI diagnostics
-- ------------------------------------------------------------
